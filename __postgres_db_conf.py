...
#	'dir_study': '<project_directory>/',
	...
	'tbl_ukb_gp_lookup': ['coding626', 'gold_product' , 'gold_daysupply_decodes', 'gold_daysupply_modes'],
	'tbl_ukb_hesin': ['hesin', 'hesin_critical', 'hesin_delivery', 'hesin_diag', 'hesin_maternity', 'hesin_oper', 'hesin_psych'],
