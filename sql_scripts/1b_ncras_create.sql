--------------Creating ncras_tumour Table ---------------------------------------
CREATE TABLE IF NOT EXISTS {SOURCE_SCHEMA}.ncras_tumour (
	e_patid					bigint,
	e_cr_patid				bigint,
	e_cr_id					bigint,
...
--------------Creating ncras_treatment Table ---------------------------------------
CREATE TABLE IF NOT EXISTS {SOURCE_SCHEMA}.ncras_treatment (
	e_patid					bigint,
	e_cr_id					bigint,
	e_cr_patid				bigint,
