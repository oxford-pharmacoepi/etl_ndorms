...
--	join {TARGET_SCHEMA_TO_LINK}._patid_deleted as t2 on t1.eid = t2.patid	--Remove withdrawal patients
...
--join {TARGET_SCHEMA_TO_LINK}._patid_deleted as t2 on t1.eid = t2.patid
left join {TARGET_SCHEMA_TO_LINK}.person as t2 on t1.eid = t2.person_id	--Remove withdrawal patients
