...
--------------------------------
With ukb_spec AS(
	select CONCAT('269-', t1.code) as specialty_source_value, t2.*
	from {SOURCE_SCHEMA}."269" as t1
	...
	select CONCAT('270-', t1.code) as specialty_source_value, t2.*
	from {SOURCE_SCHEMA}."270" as t1
