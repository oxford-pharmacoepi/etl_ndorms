...
cte3a as (
	select 
		...
		MIN(treatmentstartdate)				as visit_start_date,
	...
	group by e_patid, prescriptionid
),
cte3b as (
	select 
		e_patid 							as person_id,
...
inner join cte6 as t2 on t1.person_id = t2.person_id and t1.visit_start_date = t2.visit_start_date 
