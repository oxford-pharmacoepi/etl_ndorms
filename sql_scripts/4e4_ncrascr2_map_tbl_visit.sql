...
SELECT distinct
	...
	t1.visit_detail_concept_id as visit_concept_id, --Oncology Clinic/Center
	t1.visit_start_date as visit_start_date,
	t1.visit_start_date::timestamp as visit_start_datetime,
	t1.visit_start_date as visit_end_date, 
	t1.visit_start_date::timestamp as visit_end_datetime,
	t1.visit_type_concept_id,  -- Registry
	NULL::bigint as provider_id,		
	NULL::integer as care_site_id,
	t1.source_table as visit_source_value, 
...
left join {SOURCE_SCHEMA}.temp_visit_detail as t2 on (t1.visit_occurrence_id - 1) = t2.visit_occurrence_id 
...
select distinct
	...
	t1.visit_start_date as visit_detail_start_date,
	t1.visit_start_date::TIMESTAMP as visit_detail_start_datetime,
	t1.visit_start_date as visit_detail_end_date,
	t1.visit_start_date::TIMESTAMP as visit_detail_end_datetime,
	t1.visit_type_concept_id as visit_detail_type_concept_id,	-- Registry
	null::integer as provider_id, 		
	null::integer as care_site_id, 
	t1.source_table || ' - ' ||  t1.visit_detail_source_id as visit_detail_source_value, 
