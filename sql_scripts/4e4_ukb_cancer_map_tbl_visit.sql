...
SELECT 
	t1.visit_detail_id as visit_occurrence_id,
	...
	t1.visit_source_value as visit_source_value,
	...
	t2.visit_detail_id as preceding_visit_occurrence_id
INTO {TARGET_SCHEMA}.visit_occurrence
from cte1 as t1
left join cte1 as t2 on (t2.visit_detail_id + 1) = t1.visit_detail_id and t1.person_id = t2.person_id and t1.visit_source_value = t2.visit_source_value;
...
With cte1 AS(
	SELECT 
			...
			visit_source_value,
			visit_detail_id - 1 as tmp_id --preceding_visit_detail_id
	from {SOURCE_SCHEMA}.temp_visit_detail
)
select 
	t1.visit_detail_id as visit_detail_id, 
	t1.person_id as person_id, 
	38004268::integer as visit_detail_concept_id,
	...
	32879::integer as visit_detail_type_concept_id,
	null::integer as provider_id, 		
	null::integer as care_site_id, 
	t1.visit_source_value as visit_detail_source_value, 
...
left join cte1 as t2 on t1.visit_detail_id = t2.visit_occurrence_id
