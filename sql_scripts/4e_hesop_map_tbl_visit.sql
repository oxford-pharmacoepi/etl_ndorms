...
SELECT
	...
	WHERE t1.attended in (5); -- Mandi: This is intended to retrieve only those appointments that were attended, specifically those with a corresponding value of 5.
