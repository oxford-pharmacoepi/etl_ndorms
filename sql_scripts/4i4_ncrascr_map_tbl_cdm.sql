...
from {CHUNK_SCHEMA}.stem_{CHUNK_ID} as t1
join cte0 as t2 on t1.stem_source_id = t2.stem_source_id and t1.person_id = t2.person_id
...
select   
		...
		END as event_field_concept_id
from {CHUNK_SCHEMA}.stem_{CHUNK_ID} as t1
join cte0 as t2 on t2.stem_source_id = t1.stem_source_id  --treatment_id
