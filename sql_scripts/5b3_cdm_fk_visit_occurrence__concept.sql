...
ALTER TABLE {TARGET_SCHEMA}.visit_occurrence ADD CONSTRAINT fpk_visit_admitting FOREIGN KEY (admitting_source_concept_id) REFERENCES {VOCABULARY_SCHEMA}.concept (concept_id);
